...
The shell should feel like a research terminal: quiet dark canvas, strong hierarchy, compact navigation, and a large task surface. Scanner and Backtest are separate workspaces, not two panels in a single scroll sequence.
