"""Multi-Asset Portfolio Backtest Engine for Iron Butterfly Strategy.

Simulates ATM Straddle + OTM Wings across 6 Assets:
...
def run_iron_butterfly_portfolio_backtest(
    days: int = 75,
    ...
    print("\n" + "=" * 80)
    print("RUNNING 75-DAY MULTI-ASSET IRON BUTTERFLY BACKTEST (6 ASSETS)")
    print(f"Settings: Wing Delta={wing_delta} | TP={int(tp_pct*100)}% | SL={sl_mult}x Credit | Max Conc={max_concurrent}")
    print("=" * 80)
    ...
    for asset in ASSETS:
        ...
        res: IronButterflyBacktestResult = engine.run(df)
    ...
    portfolio_result = {
        "strategy": "Dynamic Iron Butterfly (ATM Pinning & High Credit)",
    ...
    out_path = "data/iron_butterfly_multi_asset_portfolio_results.json"
...
if __name__ == "__main__":
    run_iron_butterfly_portfolio_backtest()
