"""Multi-Asset Portfolio Backtest Engine for Calendar Spread Strategy across 6 Assets:
...
def run_calendar_spread_portfolio_backtest(
    ...
    print("\n" + "=" * 80)
    print("RUNNING 75-DAY MULTI-ASSET CALENDAR SPREAD BACKTEST (6 ASSETS)")
    print(f"Settings: TP={int(tp_pct*100)}% | SL={int(sl_pct*100)}% | Max Conc={max_concurrent}")
    print("=" * 80)
    ...
    portfolio_result = {
        "strategy": "Calendar & Diagonal Spreads (Term Structure & Theta Harvest)",
    ...
    out_path = "data/calendar_spread_multi_asset_portfolio_results.json"
